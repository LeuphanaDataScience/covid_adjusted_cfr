...
bashfile_rdump("model16",id="A",data_list_model16A,warmup=500,iter=500,
               adapt_delta=0.8,max_depth=10,init=0.5,timelimit=12,chains=4)

# Copy on cluster
 # system("scp /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/models/model16.stan
 # /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/sb_model16*
 # /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/data_SIM_model16A*
 # /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/run_models/data_S_model16*
 # UBELIX:projects/COVID_age/model/.")
# module load Boost/1.66.0-foss-2018a

# Copy back posterior samples
system("scp UBELIX:projects/COVID_age/model/S_model16A_2020-05-04-11-01-46*
       /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/posterior_samples/.")
system("scp UBELIX:projects/COVID_age/model/data_S_model16A_2020-05-04-11-01-46.R
       /home/julien/Dropbox/Unibe/covid-19/covid_adjusted_cfr/posterior_samples/.")
